...
function editdata(id)
{
    $.ajax({
        ...
        success : function(data) {
          ...
          $('#dept_manager_emailid').val(data.logistics[0].dept_manager_emailid);
...
var dept_manager_emailid = $('#dept_manager_emailid').val();
        ...
        $.ajax({
            ...
            data: {
               ...
               description : description,
                dept_manager_emailid : dept_manager_emailid
           },
            success : function(data) {
                console.log(data);
