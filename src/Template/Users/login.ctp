...
<html lang="en">
    ...
    <body class="h-100 login-wrapper">
                        ...
                        <div class="tab-content padding-top-lg">
                            <div id="signIn" class="tab-pane fade in active">
                                    <div class="form-group margin-top-lg">
                                       ...
                                       <?php echo $this->Form->input('username',["label"=>false,'type'=>'text','id'=>'','placeholder'=>'Enter E-mail Id','class'=>'form-control','autocomplete'=>'off']);?>
                                    </div>
                                    <div class="form-group">
                                        <label class="hidden" for="password">Password</label>
                                       	<?php echo $this->Form->input('password',["label"=>false,'type'=>'password','id'=>'password','placeholder'=>' Enter Password','class'=>'form-control','autocomplete'=>'off']);?>
                                    </div>
                                    <div class="form-group margin-top-lg">
                                ...
                                <div class="form-group">
                                       	...
                                       	<?php echo $this->Form->input('pass',["label"=>false,'type'=>'hidden','id'=>'pass','placeholder'=>' Enter Password','class'=>'form-control','value'=>'']);?>
                                    </div>
        ...
        <?php echo $this->Html->script(['bootstrap.min', 'custom','restrict_data']); ?>
        <script>
