...
<?php $search_listing  = $this->Url->build(['controller'=>'Users' ,'action'=>'userlist']); ?>
<style>
...
<h5><?= @$searcherror; ?></h5>
		 ...
		 <?php echo $this->Form->input('search',(['label'=>false,'type'=>'text','name' => 'search','class'=>'search form-control','id' => 'search','placeholder'=>'Search by Emp Id / Email Id / DOJ' ,'required']));?>
			...
			<?php echo $this->Form->end();?>
                   ...
                   <!--  <div class="col-md-6 col-md-offset-3">
                    <ul id="userlist" class="autocomplete">
                    </ul>
                    </div> -->
                </div>
                <hr/>
...
//              $("#userlist").append(parsedata)

//         }
//     });
//     }else{
//         console.log("data should be more than 2");
//     }
// })
