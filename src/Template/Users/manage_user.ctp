                    ...
                    <div id="interval_feedback" class="tab-pane fade">
                        ...
                        <!--<div id="BHR_annual_feedback" class="hidden">
							...
							<?php //echo $this->Form->create('', array('url' => array('controller' => 'Users', 'action' => 'getFeedbackDataForBhrinsertion'))); ?>
                                  ...
                                  <?php echo $this->Form->create('', array('url' => array('controller' => 'Users', 'action' => 'FeedbackBhrinsertion'))); ?>
                                        <div class="row">
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-8 bu_name_es_ap">
                                                        <select class="form-control" id="" name="status" required>
                                                            ...
                                                            <option value=2>Confirm</option>
                                                             ...
                                                             <div class="form-group row">
                                                    <div class="col-md-4">
                                                        <label for="90_session_interval" class="padding-top-md">Extended Date</label>
                                                    </div>
                                                    <div class="col-md-8 bu_name_es_ap">
                                                        
                    <input id="extended_date" type="text" name="extended_date" class="form-control" value=""/>
...
<div class="container-fluid container-padding-top">
    <div class="row" id="dashboard_table">
        ...
        <div class="col-md-3">
            ...
            <?php echo $this->Form->button('<i class="fa fa-trash-o" ></i> Delete', (['class' => 'btn btn-primary btn-sm', 'type' => 'submit', 'id'=>'delete_link'])); ?>
        </div>
        ...
        <div class="col-md-2 text-right">
            <a href="<?= $this->Url->build(['controller' => 'Dashboard', 'action' => 'dashboard']) ?>" class="btn btn-danger btn-sm" title="Dashboard"><i class="fa fa-bar-chart" ></i></a>
        </div>
                    ...
                    if (!empty($users)):
                        foreach ($users as $showUser):
                            ...
                            <tr data-type="completed">
                                <td><input type="checkbox" class="checkbox deletedisable" name="id[]" value="<?= $showUser['id'] ?>"></td>
                                <td><div class="text-blue logistic_user_arrangements" data-key="<?= $showUser['id'] ?>" data-sidebar-button id="<?= 'user_' . $showUser['id'] ?>" onclick="displayIdBasedData('<?= $showUser['id'] ?>');getsessions('<?= $showUser['id'] ?>');">
                                        ...
                                        <td><?= date('d/m/Y',strtotime($showUser['doj']));?></td>
                                        <td>
                                            <?php
...
<script>
$("#delete_link").prop('disabled',true);
$(document).ready(function(){
	$(".deletedisable").click(function(){
		$("#delete_link").prop('disabled',false);
	});
