                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <input class="form-control" type="number" id="interval" name="interval" placeholder="Enter days" min="1"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
										...
										<div class="col-md-3">
                                            <div class="form-group row">
                                                <div class="col-md-4">
                                                    <label for="for_supervisor" class="padding-top-md">BHR</label>
                                                </div>
                                                <div class="col-md-8 margin-top-md">
                                                    <div class="form-group margin-left-md">
                                                        <input name="for_bhr" class="checkbox" value="1" type="checkbox">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<div class="container-fluid container-padding-top">
    <div class="row">
        <div class="col-md-4">
            ...
            <?php
            echo $this->Html->link('<button class="btn btn-danger btn-sm">Manage Questions</button>', ['action' => 'questionslist'], ['escape' => false]);
            ?>            
        </div>
        <div class="col-md-4 text-center">
            <h4 class="margin-0 padding-top-xs">Manage Feedback</h4>
        </div>
        <div class="col-xs-12 margin-top-lg">
                ...
                <thead>
                    <tr>
                        ...
                        <th><div data-toggle="tooltip" data-placement="bottom" data-original-title="" class="red-tooltip">For supervisor</div></th>
						  <th><div data-toggle="tooltip" data-placement="bottom" data-original-title="" class="red-tooltip">For BHR</div></th>
