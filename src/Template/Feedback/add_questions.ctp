...
<?php $adduser = $this->Url->build(['controller' => 'Feedback', 'action' => 'questionslist']); ?>
                    <h3> <a href="<?= $adduser; ?>" class="btn btn-primary btn-sm"> Back</a> </h3>
                </div>
               ...
               <div class="col-xs-12 margin-top-lg">
				...
				<div id="add_question">
					...
					<div class="col-md-12 text-right">
                                <div class="form-group">
								 <button type="button" name="" onclick="return addquestion();"  class="btn btn-danger btn-sm" ><i class="fa fa-plus"></i> Add More</button>
